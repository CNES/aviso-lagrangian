...
class RungeKutta {
 private:
  ...
  using MoveFunction = void (RungeKutta::*)(const double t, const double x,
                                            const double y, const double u,
                                            const double v, double& xi,
                                            double& yi) const;
 ...
 public:
   ...
   * @return
   */
  inline bool Compute(const double t, const double x, const double y,
                      double& xi, double& yi,
