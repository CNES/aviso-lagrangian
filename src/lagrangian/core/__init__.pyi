...
class Field:
    ...
    def compute(self, t, x: typing.SupportsFloat, y: typing.SupportsFloat, cell: CellProperties = ...) -> tuple[float, float]|None: ...
    def fetch(self, first, last) -> tuple[float, float]|None: ...
    def unit(self) -> str: ...
    @property
