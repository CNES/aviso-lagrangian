...
class TestMapOfFiniteLyapunovExponents(unittest.TestCase):
    ...
    def test(self):
        ts = lagrangian.field.TimeSerie(self.ini)
        map_properties = lagrangian.MapProperties(360, 180, -180, -90, 1)
        ...
        lambda2 = map_of_fsle.map_of_lambda2(0)
        teta1 = map_of_fsle.map_of_theta1(0)
